...
<div class="row top-buffer">
	<div class="col-xs-offset-1 col-xs-10 col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6 col-lg-offset-4 col-lg-4" >
		...
		<form:form method="post" modelAttribute="registerForm" action="${doRegister}">
			...
			<spring:bind path="credentials">
				<div class="form-group ${status.error ? 'has-error' : ''}">
					...
					<form:input path="credentials" id="credentials" type="text" class="form-control" placeholder="${msgCredentials}"/>
			...
			<spring:bind path="username">
				<div class="form-group ${status.error ? 'has-error' : ''}">
					...
					<form:input path="username" id="username" type="text" class="form-control" placeholder="${msgUsername}"/>
