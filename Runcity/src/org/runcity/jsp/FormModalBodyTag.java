...
public class FormModalBodyTag extends SimpleTagSupport {
	 ...
	 * new TagWriter(pageContext); if (modal) {
	 * 
	 * tagWriter.startTag("div"); tagWriter.writeAttribute("class",
	 * "modal-body"); } return EVAL_BODY_INCLUDE; }
	 * 
