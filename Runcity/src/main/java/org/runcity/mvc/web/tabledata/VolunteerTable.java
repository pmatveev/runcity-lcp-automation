...
public class VolunteerTable extends AbstractTable {
	...
	@JsonView({ ByControlPoint.class, ByConsumerGame.class, ByConsumerControlPoint.class, ByGame.class,
			ByGameControlPoint.class })
	...
	protected VolunteerTable(String id, String title, String simpleTitle, String ajaxData, MessageSource messageSource,
			DynamicLocaleList localeList, Object... titleArgs) {
		super(id, title, simpleTitle, ajaxData, messageSource, localeList, titleArgs);
	}

	public static VolunteerTable initVolunteersByGame(MessageSource messageSource, DynamicLocaleList localeList,
			Game g) {
		VolunteerTable table = new VolunteerTable("volunteerTableByGame", "volunteer.tableHeaderByGameControlPoint",
				"volunteer.simpleTableHeaderByGameControlPoint", "/api/v1/volunteerTableByGame?gameId=" + g.getId(),
				messageSource, localeList, StringUtils.xss(g.getName()));
		...
		table.buttons.add(new ButtonDefinition("actions.create", null, "btn",
				"createform:volunteerCreateEditByGameCPForm", null));
		table.buttons.add(new ButtonDefinition("actions.edit", null, "btn", "form:volunteerCreateEditByGameCPForm:id",
				"selectedSingle"));
		table.buttons.add(new ButtonDefinition("actions.delete", "confirmation.delete", "btn",
				"ajax:DELETE:/api/v1/volunteerDelete/:id", "selected"));
	...
	public static VolunteerTable initCoordinatorsByGame(MessageSource messageSource, DynamicLocaleList localeList,
			Game g) {
		VolunteerTable table = new VolunteerTable("coordinatorTableByGame", "volunteer.tableHeaderByGame",
				"volunteer.simpleTableHeaderByGame", "/api/v1/coordinatorTableByGame?gameId=" + g.getId(),
				messageSource, localeList, StringUtils.xss(g.getName()));
		...
		table.buttons.add(new ButtonDefinition("actions.create", null, "btn",
				"createform:volunteerCreateEditByGameCoordForm", null));
		table.buttons.add(new ButtonDefinition("actions.edit", null, "btn",
				"form:volunteerCreateEditByGameCoordForm:id", "selectedSingle"));
		table.buttons.add(new ButtonDefinition("actions.delete", "confirmation.delete", "btn",
				"ajax:DELETE:/api/v1/volunteerDelete/:id", "selected"));
	...
	public static VolunteerTable initVolunteersByConsumer(MessageSource messageSource, DynamicLocaleList localeList,
			Consumer c) {
		VolunteerTable table = new VolunteerTable("volunteerTableByConsumer",
				"volunteer.tableHeaderByConsumerControlPoint", "volunteer.simpleTableHeaderByConsumerControlPoint",
				"/api/v1/volunteerTableByConsumer?consumerId=" + c.getId(), messageSource, localeList,
				StringUtils.xss(c.getCredentials()));

		table.columns.add(new ColumnDefinition("id", null).setHidden(true));
		table.columns.add(new ColumnDefinition("game", "volunteer.game"));
		table.columns.add(new ColumnDefinition("controlPoint", "volunteer.controlPoint"));
		table.columns
				.add(new ColumnDefinition("dateFrom", "volunteer.dateFrom").setDateTimeFormat().setSort("desc", 0));
		table.columns.add(new ColumnDefinition("dateTo", "volunteer.dateTo").setDateTimeFormat());

		return table;
	}

	public static VolunteerTable initCoordinatorsByConsumer(MessageSource messageSource, DynamicLocaleList localeList,
			Consumer c) {
		VolunteerTable table = new VolunteerTable("coordinatorTableByConsumer", "volunteer.tableHeaderByConsumerGame",
				"volunteer.simpleTableHeaderByConsumerGame",
				"/api/v1/coordinatorTableByConsumer?consumerId=" + c.getId(), messageSource, localeList,
				StringUtils.xss(c.getCredentials()));
	...
	public VolunteerTable(MessageSource messageSource, DynamicLocaleList localeList, ControlPoint c) {
		super("volunteerTableByCP", "volunteer.tableHeaderByControlPoint", "volunteer.simpleTableHeaderByControlPoint",
				"/api/v1/volunteerTableByCP?controlPointId=" + c.getId(), messageSource, localeList, StringUtils.xss(c.getName()));
		...
		this.buttons.add(
				new ButtonDefinition("actions.create", null, "btn", "createform:volunteerCreateEditByCPForm", null));
		this.buttons.add(new ButtonDefinition("actions.edit", null, "btn", "form:volunteerCreateEditByCPForm:id",
				"selectedSingle"));
